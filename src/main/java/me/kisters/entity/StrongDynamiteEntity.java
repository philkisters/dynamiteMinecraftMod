...
public class StrongDynamiteEntity extends ThrownItemEntity {
    public StrongDynamiteEntity(EntityType<? extends StrongDynamiteEntity> entityType, World world) {
        super(entityType, world);
    }
    
    public StrongDynamiteEntity(World world, LivingEntity owner) {
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.getEntityWorld().isClient()) {
            this.getEntityWorld().createExplosion(this, this.getX(), this.getY(), this.getZ(),
                    2.5f, World.ExplosionSourceType.TNT);
